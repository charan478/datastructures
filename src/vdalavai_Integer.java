...
public class vdalavai_Integer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (data_structure.equals("bst")) {
            BST<Integer> tree = new BST<Integer>(); // Change this
            long totalTime = 0;
            ...
            while ((line = br.readLine()) != null) {
                ...
                Integer value =Integer.parseInt(line.split("\t",2)[1].trim());  // Change this
        ...
        if (data_structure.equals("rbtree")) {
            RBTREE<Integer> tree = new RBTREE<Integer>();  // Change this
            long totalTime = 0;
            ...
            while ((line = br.readLine()) != null) {
                ...
                Integer value = Integer.parseInt(line.split("\t")[1].trim());  // Change this
                long startTime = System.nanoTime();
                if (mode == 1) {
                    if (!tree.search(value)) {
                        tree.insert(value);
        ...
        if (data_structure.equals("skiplist")) {
            SkipList<Integer> tree = new SkipList<Integer>();  // Change this
            long totalTime = 0;
        ...
        if (data_structure.equals("splaytree")) {
            SplayTree<Integer> tree = new SplayTree<Integer>();  // Change this
            long totalTime = 0;

...
public class vdalavai {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (data_structure.equals("bst")) {
            BST<String> tree = new BST<String>(); // Change this
            long totalTime = 0;
            ...
            while ((line = br.readLine()) != null) {
                ...
                String value = line.split("\t",2)[1];  // Change this
        ...
        if (data_structure.equals("rbtree")) {
            RBTREE<String> tree = new RBTREE<String>();  // Change this
            long totalTime = 0;
            ...
            while ((line = br.readLine()) != null) {
                ...
                String value = line.split("\t")[1];  // Change this
                long startTime = System.nanoTime();
                if (mode == 1) {
                    if (!tree.search(value)) {
                        tree.insert(value);
        ...
        if (data_structure.equals("skiplist")) {
            SkipList<String> tree = new SkipList<String>();  // Change this
            long totalTime = 0;
        ...
        if (data_structure.equals("splaytree")) {
            SplayTree<String> tree = new SplayTree<String>();  // Change this
            long totalTime = 0;
